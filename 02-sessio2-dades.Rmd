...
```
  ...
  <p>-    Crea un vector amb els noms dels gens PAX6, ZIC2, OCT4 i SOX2. Quin tipus de vector és?</p>
...
Per carregar les dades (fitxer *CursIntroducciAR-CRC_DATA.csv*) utilitzarem directament el codi descrit a *CursIntroducciAR-CRC_R.R*. Obrim l'script amb RStudio, definim el directori de treball i executem totes les línies de codi.
...
#Read Data
data=read.csv('[....]/CursIntroducciAR-_DATA.csv')
```
...
## Exportar la feina feta

Segurament en algun punt del projecte en el que estiguis treballant voldràs parar i continuar en un altre moment. Per guardar els objectes que has anat generant fins al moment tens diferents opcions:

-   Guardar l'*Enviornment*: `save.image("C:/Users/Desktop/sessio2.RData")`

-   Guardar data frames especifics que haigs creat en forma de taula de dades (en format .csv o .txt, per exemple): `write.csv2(data_tidy, "C:/Users/Desktop/CursIntroducciAR-CRC_DATA_tidy.csv")`

Aquestes són dues alternatives que generen dos tipus de fitxers molt diferents: la primera guarda tots els objectes de l'ambient de treball i només es pot obrir amb R, en canvi la segona guarda una taula de dades concreta en format de text que es pot obrir des d'altres programes com per exemple excel. En funció de les teves necessitats, pots optar de guardar la feina fet d'una manera o d'una altra.
